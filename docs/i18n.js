...
const copy = {
  en: {
    ...
    copyForRepo: "Copy for my repo",
    contractNumberLabel: "No.",
    translationNote: "Prompt source text is preserved in English.",
    repoCopyEyebrow: "Make it runnable",
    repoCopyTitle: "Copy for your repo",
    objective: "Goal",
    context: "Context",
    ...
    adaptedCopied: "Repo-ready goal copied",
  ...
  zh: {
    ...
    repoCopyEyebrow: "改成可运行版本",
    repoCopyTitle: "复制项目版 /goal",
    objective: "目标",
    context: "上下文",
    constraints: "约束",
    verification: "验证",
