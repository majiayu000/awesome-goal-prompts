...
const copy = {
  ...
  zh: {
    ...
    metaDescription: "可检索、可复制的 /goal 示例库，面向 Codex、Claude Code、Hermes 等编程智能体。",
    ...
    navContribute: "贡献",
    navGithub: "GitHub",
    heroEyebrow: "可直接复制的 /goal 用例 · 2026",
    heroTitleLead: "goal 不是",
    heroTitleStrike: "许愿，",
    heroTitleBridge: "而是",
    heroTitleEm: "任务单。",
    heroManifesto: "给智能体一个明确目标、必要上下文、不能改的边界、验证方式和停止条件。先从下面的真实用例里找相近场景，再改成当前仓库的文件、命令和验收标准，复制到 Codex、Claude Code 或 Hermes。",
    ...
    sealWord: "Codex",
    statContracts: "/goal 示例",
    statCategories: "分类",
    statExternalSources: "公开来源",
    statAdvanced: "高难任务",
    guideEyebrow: "§ 使用指南",
